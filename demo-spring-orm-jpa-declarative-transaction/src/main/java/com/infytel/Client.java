...
public class Client implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		PlanDTO plan1 = new PlanDTO(2, "INFY_60", 60, 60);
		CustomerDTO customer1 = new CustomerDTO(8009009011L, "Debashis", 27, 'M', "BBSR", "INFY", plan1);

		customerService.insert(customer1);
		logger.info("Records are successfully added..");

		Long phoneNo = 8009009009L;
		String newCurrentPlan = "INFY000001";
